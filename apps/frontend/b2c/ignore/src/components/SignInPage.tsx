...
export function SignInPage({ onNavigate }: SignInPageProps) {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast.success("Welcome back to Flybeth!", {
        description: "You've successfully signed in. Let's plan your next adventure!",
      });
      onNavigate("home");
    }, 2000);
  };
      ...
      >
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border-2 border-white/50">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="mb-2">Welcome Back, Traveler!</h2>
