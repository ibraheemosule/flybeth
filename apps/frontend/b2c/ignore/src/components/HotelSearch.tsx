        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="destination" placeholder="City, hotel, landmark..." className="pl-11 h-12 border-2 focus:border-primary" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="guests" placeholder="2 Adults, 1 Room" className="pl-11 h-12 border-2 focus:border-primary" />
            </div>
          </div>
        </div>

        <div className="flex justify-end">
          <Button className="bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90 h-12 px-12 shadow-lg hover:shadow-xl transition-all">
