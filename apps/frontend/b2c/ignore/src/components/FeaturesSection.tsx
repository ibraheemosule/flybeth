import { Shield, Compass, Heart, Rocket, Award, Headphones } from "lucide-react";
...
const features = [
  {
    ...
    description: "Smart search technology that finds exactly what you're dreaming of",
    color: "bg-primary"
  },
  {
    id: 2,
    ...
    description: "Handpicked recommendations tailored to your unique travel style",
    color: "bg-accent"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "Found a better price? We'll match it and give you an extra 10% off",
    color: "bg-primary"
  },
  {
    id: 6,
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            We're not just another booking site. We're your travel companion, dedicated to making every journey unforgettable.
          </p>
        </motion.div>
