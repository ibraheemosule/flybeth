...
import { Eye, EyeOff, Mail, Lock, User, Plane, Home } from "lucide-react";
...
export function SignUpPage({ onNavigate }: SignUpPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent via-primary to-accent relative overflow-hidden flex items-center justify-center px-4 py-12">
      {/* Animated background */}
      ...
      >
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border-2 border-white/50">
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90 shadow-lg hover:shadow-xl transition-all"
        ...
        >
          ...
          <p className="text-xs text-white/70">
            By signing up, you'll get access to exclusive deals and personalized travel recommendations
          </p>
        </motion.div>
      </motion.div>
    </div>
