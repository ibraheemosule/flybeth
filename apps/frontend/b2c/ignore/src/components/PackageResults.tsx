...
import { Package, Plane, Hotel, MapPin, Star, ArrowRight, Car } from "lucide-react";
...
const mockPackages = [
  {
    ...
    originalPrice: 2499,
    savings: 600,
    image: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWxkaXZlcyUyMHJlc29ydHxlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.9,
    reviews: 543,
    nights: 7,
    includes: {
  ...
  },
  {
    ...
    originalPrice: 2199,
    savings: 600,
    image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwYXJpcyUyMGVpZmZlbCUyMHRvd2VyfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.7,
    reviews: 892,
    nights: 10,
    includes: {
    ...
    highlights: ["Eiffel Tower Tour", "Colosseum Visit", "Train Between Cities"],
  },
  {
    id: 3,
    ...
    originalPrice: 1799,
    savings: 500,
    image: "https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3N0YSUyMHJpY2ElMjBiZWFjaHxlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.8,
    reviews: 678,
    nights: 8,
    includes: {
  ...
  },
  {
    ...
    originalPrice: 2399,
    savings: 650,
    image: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0aGFpbGFuZCUyMHRlbXBsZXxlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.9,
    reviews: 1234,
    nights: 12,
    includes: {
...
export function PackageResults({ searchParams, onClose, onSelectPackage }: PackageResultsProps) {
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-muted-foreground">
                {searchParams.destination} • {searchParams.departDate} - {searchParams.returnDate}
              </p>
            </div>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-2/3 p-6 flex flex-col justify-between">
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                            ...
                            <span>{pkg.destination} • {pkg.nights} nights</span>
                          </div>
                        </div>
                      </div>
                        ...
                        {(searchParams.includes?.flights !== false) && (
                          <div className="flex items-start gap-2 p-3 rounded-lg bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/10">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">{pkg.includes.flight}</p>
                            </div>
                          </div>
                        )}
                        {(searchParams.includes?.hotels !== false) && (
                          <div className="flex items-start gap-2 p-3 rounded-lg bg-gradient-to-r from-accent/5 to-primary/5 border border-accent/10">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">{pkg.includes.hotel}</p>
                            </div>
                          </div>
                        )}
                        {shouldShowCarInfo && (
                          <div className="flex items-start gap-2 p-3 rounded-lg bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/10">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">{pkg.includes.car}</p>
                            </div>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="flex items-end justify-between pt-4 border-t">
                      ...
                      <Button
                        onClick={() => onSelectPackage({ ...pkg, searchParams })}
