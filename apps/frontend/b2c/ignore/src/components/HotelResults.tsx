...
const mockHotels = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 2103,
    image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXNvcnQlMjBob3RlbHxlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    location: "Beachfront",
  ...
  },
  {
    ...
    rating: 4.3,
    reviews: 567,
    image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwzfHxob3RlbCUyMHJvb218ZW58MXx8fHwxNzYzNjE3OTM5fDA&ixlib=rb-4.1.0&q=80&w=1080",
...
export function HotelResults({ searchParams, onClose, onSelectHotel }: HotelResultsProps) {
  return (
    <motion.div
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="mb-2">Available Hotels</h2>
              <p className="text-muted-foreground">
                {searchParams.destination} • {searchParams.checkInDate} - {searchParams.checkOutDate}
              </p>
            </div>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-2/3 p-6 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        {hotel.amenities.length > 4 && (
                          <Badge variant="outline" className="bg-gradient-to-r from-accent/5 to-primary/5">
                    ...
                    <div className="flex items-end justify-between pt-4 border-t">
                      ...
                      <Button
                        onClick={() => onSelectHotel({ ...hotel, searchParams })}
