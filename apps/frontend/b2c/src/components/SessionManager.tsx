...
const SessionManager = ({
  ...
  const { isAuthenticated, updateLastActivity, logout } = useAuthStore()
  const [sessionStatus, setSessionStatus] = useState<'active' | 'warning' | 'expired' | 'refreshing'>('active')
  ...
  }, [isAuthenticated, updateLastActivity, autoExtendOnActivity, showSessionWarning])
  ...
  }, [isAuthenticated, isTokenValid, timeUntilExpiry, warningThresholdMinutes, showExtensionPopup])
...
const SessionWarningModal = () => {
  ...
  const { timeUntilExpiry, extendSession, dismissWarning, sessionStatus } = context
      ...
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div className="mt-2">
                  ...
                  {sessionStatus === 'refreshing' && (
                    <div className="mt-3 flex items-center">
                      ...
                      <span className="text-sm text-blue-600">Extending session...</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            >
              {sessionStatus === 'refreshing' ? 'Extending...' : 'Extend Session'}
            </button>
            <button
              type="button"
