...
//                 <li>Communicate with you about your reservations and updates</li>
//                 <li>Send you promotional offers and personalized recommendations (with your consent)</li>
...
//               </p>
//               <ul className="list-disc list-inside space-y-2 ml-4">
//                 <li><strong>Travel Partners:</strong> Airlines, hotels, and other service providers to fulfill your bookings</li>
//                 <li><strong>Service Providers:</strong> Third-party vendors who help us operate our platform (payment processors, customer support, analytics)</li>
...
//               </ul>
//               <p className="mt-4">
//                 To exercise these rights, please contact us at <a href="mailto:privacy@flybeth.com" className="text-primary hover:underline">privacy@flybeth.com</a>.
//               </p>
//             </div>
//           </section>
...
//             <div className="space-y-4 text-muted-foreground">
//               <p>
//                 Your information may be transferred to and processed in countries other than your country of residence. These countries may have data protection laws different from your jurisdiction. We ensure appropriate safeguards are in place to protect your information.
//               </p>
//             </div>
//           </section>
...
//                 <p><strong>Email:</strong> <a href="mailto:privacy@flybeth.com" className="text-primary hover:underline">privacy@flybeth.com</a></p>
//                 <p><strong>Phone:</strong> 1-800-FLYBETH (1-800-359-2384)</p>
//                 <p><strong>Address:</strong> Flybeth Inc., 123 Travel Lane, San Francisco, CA 94105</p>
//               </div>
//             </div>
//           </section>
//         </motion.div>
