...
export function PassengerForm({
  ...
  const updatePhone = (
    field: "countryCallingCode" | "number",
    value: string
  ) => {
    const countryCode =
      field === "countryCallingCode" ? value.split("|")[0] : value;
    const newData = {
      ...passengerData,
      contact: {
      ...
      <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={e =>
                      updateContact("emailAddress", e.target.value)
                    }
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Select
                    value={passengerData.contact.phones[0].countryCallingCode}
                    onValueChange={value =>
                      updatePhone("countryCallingCode", value)
                    }
                  >
        ...
        {isInternational && passengerData.documents && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor={`passport-${passengerNumber}`}>
                  Passport Number *
                </Label>
                <Input
                  id={`passport-${passengerNumber}`}
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={value =>
                    updateDocument("issuanceCountry", value)
                  }
                >
            ...
            <p className="text-xs text-muted-foreground bg-blue-50 p-3 rounded-lg border border-blue-200">
              📝 <strong>Important:</strong> Passport must be valid for at least
              6 months from travel date. All information must match your
              passport exactly.
            </p>
          </div>
        )}
