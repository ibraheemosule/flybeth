...
export function CustomersSection() {
  ...
  const filteredCustomers = customers.filter(customer => {
    ...
    return (
      matchesSearch && matchesDepartment && matchesService && matchesStatus
    );
  });
    ...
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="p-5">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            From{" "}
            {filteredCustomers.reduce((sum, c) => sum + c.totalBookings, 0)}{" "}
            bookings
          </p>
        </Card>
        ...
        <Card className="p-5">
          ...
          <p className="text-2xl font-bold text-orange-600">
            $
            {avgSpendPerCustomer.toLocaleString(undefined, {
            ...
            <Card className="p-5 hover:shadow-lg transition-all h-full">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2 border-t">
                  ...
                  >
                    {getServiceIcon(customer.favoriteService)}{" "}
                    {customer.favoriteService}
                  </Badge>
                </div>
