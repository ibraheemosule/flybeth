...
interface AttractionResultsPageProps {
  searchParams: {
    destination: string;
    date?: string;
    category: string;
...
const mockAttractions = [
  {
    ...
    duration: "3 hours",
    image:
      "https://images.unsplash.com/photo-1544551763-46a013bb70d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxib2F0JTIwY3J1aXNlfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.8,
    reviews: 1234,
  ...
  },
  {
    ...
    duration: "4 hours",
    image:
      "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmb29kJTIwdG91cnxlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.9,
    reviews: 892,
  ...
  },
  {
    ...
    duration: "2.5 hours",
    image:
      "https://images.unsplash.com/photo-1551632811-561732d1e306?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx6aXAlMjBsaW5lfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.7,
    reviews: 543,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1564399579883-451a5d44ec08?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtdXNldW0lMjBhcnR8ZW58MXx8fHwxNzYzNjE3OTM5fDA&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.6,
    reviews: 2103,
  ...
  },
  {
    ...
    duration: "5 hours",
    image:
      "https://images.unsplash.com/photo-1544551763-77ef2d0cfc6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbm9ya2VsaW5nfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.9,
    reviews: 678,
  ...
  },
  {
    ...
    duration: "2 hours",
    image:
      "https://images.unsplash.com/photo-1539650116574-75c0c6d73c6f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3YWxraW5nJTIwdG91cnxlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.5,
    reviews: 456,
    groupSize: "Up to 25 people",
    highlights: ["Expert guide", "Historic landmarks", "Photo stops"],
    includes: ["Guided tour", "Map", "Historical insights"],
    cancellation: "Free cancellation up to 2h",
  },
  {
    id: 7,
    ...
    duration: "3.5 hours",
    image:
      "https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aW5lJTIwdGFzdGluZ3xlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.8,
    reviews: 789,
    groupSize: "Small group (8 max)",
    highlights: ["Premium wines", "Local vineyard", "Cheese pairing"],
    includes: ["Wine tasting", "Light bites", "Transportation"],
    cancellation: "Free cancellation up to 24h",
  },
  {
    id: 8,
    ...
    duration: "4 hours",
    image:
      "https://images.unsplash.com/photo-1544551763-46a013bb70d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxrYXlha2luZ3xlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.0.3&q=80&w=1080",
    rating: 4.6,
    reviews: 321,
    groupSize: "Up to 12 people",
    highlights: ["Scenic routes", "Wildlife spotting", "Professional guide"],
    includes: ["Kayak & equipment", "Safety briefing", "Snacks"],
    cancellation: "Free cancellation up to 24h",
  },
];

export default function AttractionResultsPage({
  searchParams = {
  ...
  onClose,
  onSelectAttraction,
}: Partial<AttractionResultsPageProps>) {
  const handleClose = () => {
    if (onClose) onClose();
    console.log("Close search results");
  };

  const handleSelectAttraction = (attraction: any) => {
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-3xl font-bold mb-2">Things To Do</h2>
        ...
        >
          <p className="text-muted-foreground">
            All activities include insurance. Cancellation policies vary by
            provider. 🎟️
          </p>
        </motion.div>
      </div>
