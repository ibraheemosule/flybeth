...
import { useThemeStore, themeColors, type ColorTheme } from "../../../stores";
...
export function SettingsPage({ onNavigate }: SettingsPageProps) {
  ...
  // Sync custom theme colors with store
  useEffect(() => {
    if (customTheme) {
      setCustomPrimary(customTheme.primary);
      setCustomAccent(customTheme.accent);
    }
  }, [customTheme]);
            ...
            {activeTab === "theme" && (
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div
                    className="rounded-xl p-6 border border-primary/10"
                    style={{
                      background:
