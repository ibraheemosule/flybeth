        ...
        >
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                By accessing and using Flybeth.com, you accept and agree to be
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                Flybeth acts as an intermediary between you and travel service
                providers (airlines, hotels, etc.). We facilitate bookings but
                do not own, operate, or control the transportation or
                accommodation services.
              </p>
              <p>
                All bookings are subject to the terms and conditions of the
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>When you make a booking through Flybeth, you agree to:</p>
              ...
              <p>
                Prices displayed include all mandatory taxes and fees unless
                otherwise stated. Prices are subject to change until payment is
                complete.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                Cancellation and refund policies vary by booking type and
                service provider. Please review our Refund Policy and the
                specific terms of your booking before canceling.
              </p>
              <p>
                Flybeth will process refunds according to our refund policy, but
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Ensuring you have valid travel documents (passport, visa,
                  etc.)
                </li>
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              ...
              <p className="pt-2">
                ...
                service fee, excluding amounts paid to third-party providers.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                All content on Flybeth.com, including logos, text, graphics, and
                software, is the property of Flybeth and protected by copyright
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                Your use of Flybeth is also governed by our Privacy Policy. We
                collect and use personal information as described in that
                policy.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                Flybeth reserves the right to modify these Terms and Conditions
          ...
          <Card className="bg-white/90 backdrop-blur-lg border-2">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                ...
                of Delaware, United States. Any disputes shall be resolved in
