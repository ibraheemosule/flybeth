    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex-1 flex flex-col items-center">
        ...
        <div className="w-full relative">
          ...
          <Plane className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-4 w-4 text-[#10b981] rotate-90" />
              ...
              {flight.stops.map((stop, idx) => (
                ...
                >
                  <div className="relative group">
                    <div className="h-2 w-2 rounded-full bg-[#10b981] border-2 border-white shadow-md -translate-x-1/2" />
                ...
                <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 border-2 hover:border-[#10b981]/50 bg-white/80 backdrop-blur-sm">
                  <div className="p-6">
                    <div className="flex flex-col gap-6">
                      ...
                      {/* Price and CTA */}
                      <div className="flex lg:flex-row items-center justify-between gap-4 p-4 rounded-xl bg-gradient-to-br from-[#2563eb]/5 to-[#10b981]/5">
