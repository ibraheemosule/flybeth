...
import { useAttractionsStore } from "@/stores";
...
const mockAttractions = [
  {
    ...
    duration: "3 hours",
    image:
      "https://images.unsplash.com/photo-1544551763-46a013bb70d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxib2F0JTIwY3J1aXNlfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.8,
    reviews: 1234,
  ...
  },
  {
    ...
    duration: "4 hours",
    image:
      "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmb29kJTIwdG91cnxlbnwxfHx8fDE3NjM2MTc5Mzl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.9,
    reviews: 892,
  ...
  },
  {
    ...
    duration: "2.5 hours",
    image:
      "https://images.unsplash.com/photo-1551632811-561732d1e306?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx6aXAlMjBsaW5lfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.7,
    reviews: 543,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1564399579883-451a5d44ec08?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtdXNldW0lMjBhcnR8ZW58MXx8fHwxNzYzNjE3OTM5fDA&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.6,
    reviews: 2103,
  ...
  },
  {
    ...
    duration: "5 hours",
    image:
      "https://images.unsplash.com/photo-1544551763-77ef2d0cfc6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbm9ya2VsaW5nfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.9,
    reviews: 678,
...
export default function AttractionResults() {
  const { searchParams, setSelectedAttraction } = useAttractionsStore();
  ...
  const onSelectAttraction = (attraction: any) => {
    ...
    router.push("/booking/attraction");
  };
  return (
    <motion.div
