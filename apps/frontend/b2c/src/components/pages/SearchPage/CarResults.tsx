...
const mockTaxis = [
  {
    ...
    price: 35,
    pricePerDay: false,
    image: "https://images.unsplash.com/photo-1526128260932-74d3a97b5b4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0YXhpJTIwY2FyfGVufDF8fHx8MTc2MzYxNzkzOXww&ixlib=rb-4.1.0&q=80&w=1080",
    passengers: 4,
    luggage: 2,
    transmission: "Automatic",
    fuelType: "Gasoline",
  ...
  },
  {
    ...
    price: 55,
    pricePerDay: false,
    image: "https://images.unsplash.com/photo-1502877338535-766e1452684a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVtaXVtJTIwc2VkYW58ZW58MXx8fHwxNzYzNjE3OTM5fDA&ixlib=rb-4.1.0&q=80&w=1080",
    passengers: 6,
    luggage: 4,
    transmission: "Automatic",
    fuelType: "Gasoline",
...
export default function CarResults({ searchParams, onClose, onSelectCar }: CarResultsProps) {
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="mb-2">{isTaxi ? "Airport Transfer" : "Car Rental"}</h2>
                    ...
                    <div>
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mb-3">{vehicle.supplier}</p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                        <div className="flex items-center gap-2 p-3 rounded-lg bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/10">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-semibold">{vehicle.passengers}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 p-3 rounded-lg bg-gradient-to-r from-accent/5 to-primary/5 border border-accent/10">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-semibold">{vehicle.luggage}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 p-3 rounded-lg bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/10">
                    ...
                    <div className="flex items-end justify-between pt-4 border-t mt-4">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {isTaxi ? "One-way transfer" : "Includes basic insurance"}
                        </p>
                      </div>
                      <Button
