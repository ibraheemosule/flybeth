    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white py-12 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-8">
          {filteredFaqs.map((category, categoryIndex) => {
            ...
            return (
              ...
              >
                <Card className="bg-white/90 backdrop-blur-lg shadow-lg hover:shadow-xl transition-shadow">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-3">
                    {category.questions.map((faq, index) => {
                      ...
                      return (
                        <div
                          key={key}
                          className="border rounded-xl overflow-hidden bg-white/50 backdrop-blur-sm hover:border-primary/30 transition-colors"
                        >
                          <button
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5 backdrop-blur-lg shadow-xl">
