    ...
    >
      <div className="flex flex-col items-center gap-8">
          ...
          <div className="relative w-48 h-48 flex items-center justify-center">
            {travelIcons.map((item, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`p-2 rounded-full bg-gradient-to-br ${item.color} shadow-lg`}
                  >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="relative">
                  ...
                  {/* Main icon */}
                  <div
                    className={`relative p-6 rounded-2xl bg-gradient-to-br ${currentIcon.color} shadow-2xl`}
                  >
                    <CurrentIcon
        ...
        <motion.div
          ...
          className="relative"
        >
          <span className="text-3xl font-bold text-blue-600">FlyBeth</span>
        </motion.div>
