...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    const authCookie = request.cookies.get("flybeth-auth")?.value;
    ...
    if (refreshResult.success) {
      ...
      response.cookies.set("flybeth-auth", JSON.stringify(newAuthState), {
        httpOnly: true,
...
function redirectToLogin(request: NextRequest): NextResponse {
  ...
  // Clear auth cookies
  response.cookies.delete("flybeth-auth");
