...
export const UsersPage: React.FC = () => {
  const users = [
    ...
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'Business', status: 'Active', joined: '2024-02-20' },
    { id: 3, name: 'Mike Johnson', email: 'mike@example.com', role: 'Customer', status: 'Inactive', joined: '2024-03-10' },
    { id: 4, name: 'Sarah Wilson', email: 'sarah@example.com', role: 'Admin', status: 'Active', joined: '2024-01-05' }
  ];
