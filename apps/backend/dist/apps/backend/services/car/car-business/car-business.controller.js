...
exports.CarBusinessController = void 0;
const car_helper_1 = require("../car-shared/car.helper");
class CarBusinessController {
    constructor() {
        ...
        this.createCarRental = async (req, res) => {
            try {
                ...
                if (bookingData.travelers.length >= 10)
                    discount += 5; // Group discount
                if (servicePrice > 10000)
                    discount += 5; // High-value booking discount
        ...
        this.createBulkBooking = async (req, res) => {
            try {
                ...
                for (const bookingData of bulkData.bookings) {
                    ...
                    if (bulkData.bookings.length >= 20)
        ...
        this.approveBooking = async (req, res) => {
            try {
                const { bookingId } = req.params;
        ...
        this.modifyBooking = async (req, res) => {
            try {
                const { bookingId } = req.params;
        ...
        this.getBookingAnalytics = async (req, res) => {
            try {
...
exports.CarBusinessController = CarBusinessController;
